 ...
 */
final class Version20230214090947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient_quantity (id INT AUTO_INCREMENT NOT NULL, ingredient_id INT NOT NULL, recipe_id INT DEFAULT NULL, quantity INT NOT NULL, INDEX IDX_EDF546B8933FE08C (ingredient_id), INDEX IDX_EDF546B859D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
